   ...
   let source =["music/Battery.mp3","music/Master Of Puppets.mp3","music/The Thing That Should Not Be.mp3","music/Welcome Home (Sanitarium).mp3","music/Disposable Heroes.mp3","music/Leper Messiah.mp3","music/Orion (Instrumental).mp3","music/Damage, Inc..mp3",];
...
let lheight = 0;
console.log(`Cover height: ${lheight}`);
for(let i = 0; i < songs.length; i++)
{
    lheight += songs[i].clientHeight;
    console.log(`${i}: ${songs[i].clientHeight}`);
}
lheight+=300;
console.log(lheight);
document.getElementById("sidebar").style.height = lheight + "px";
